...
namespace FSParam
{
    ...
    /// </summary>
    public class LiveParam : SoulsFile<LiveParam>
    {
        /// <summary>
        ...
        public class Row
        {
            ...
            public Row(int id, string name, LiveParam parent)
            {
                ID = id;
                Name = name;
                Parent = parent;
            ...
            public Row(Row clone, LiveParam newParent)
            {
                Parent = newParent;
                ID = clone.ID;
                Name = clone.Name;
        ...
        public LiveParam(LiveParam source)
        {
        ...
        public void ApplyParamdef(PARAMDEF def)
        {
            ...
            for (int i = 0; i < def.Fields.Count; i++)
            {
                ...
                else
                {
                    ...
                    lastSize = (uint)GetValueSize(newBitType);
        ...
        public static int GetValueSize(PARAMDEF.DefType type)
        {
            switch (type)
            {
                ...
                case PARAMDEF.DefType.fixstrW:
                    return 2;
                default:
                    throw new NotImplementedException($"No value size specified for {"DefType"}.{type}");
            }
        }
